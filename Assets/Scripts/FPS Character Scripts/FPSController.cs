...
public class FPSController : NetworkBehaviour {
    ...
    void Update () {
        ...
        //E.G. MEANING WE ARE NOT RUNNING THE CODE
        //ON OUR OWN COMPUTER
        if (!isLocalPlayer)
        {
            //IF THIS STATEMENT IS TRUE
            //AND WE EXECUTE THE return CODE
            //ALL CODE THAT IS WRITTEN AFTER THE return WILL NOT BE EXECUTED
            return; 
        }
    ...
    bool CanGetUp()
    {
        ...
        if (Physics.SphereCast(groundRay, charController.radius + 0.5f,
